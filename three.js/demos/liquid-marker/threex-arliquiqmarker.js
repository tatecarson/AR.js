...
THREEx.ArLiquidMarker = function(videoTexture) {
  ...
  for (
    var faceIndex = 0;
    faceIndex < object3d.geometry.faces.length;
    faceIndex++
  ) {
    originalsFaceVertexUvs[0][faceIndex] = [];
    originalsFaceVertexUvs[0][
      faceIndex
    ][0] = object3d.geometry.faceVertexUvs[0][faceIndex][0].clone();
    originalsFaceVertexUvs[0][
      faceIndex
    ][1] = object3d.geometry.faceVertexUvs[0][faceIndex][1].clone();
    originalsFaceVertexUvs[0][
      faceIndex
    ][2] = object3d.geometry.faceVertexUvs[0][faceIndex][2].clone();
  ...
  this.update = function() {
    object3d.material.uniforms.time.value =
...
THREEx.ArLiquidMarker.vertexShader =
